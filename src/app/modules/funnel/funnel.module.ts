...
@NgModule({
  declarations: [CameraComponent,LoanPresentationComponent, LoanFormComponent, EmailConfirmComponent, ValidateEmailComponent, OtpComponent, ChooseAmountComponent, SimulationComponent, AuthorizationComponent, BiometricComponent, StatusComponent, ValidateBiometricComponent, BirthComponent, OccupationComponent, PreBiometricComponent, BiometricSuccessComponent, OtpSuccessComponent, AddAccountsComponent, DiscountedAccountsComponent, AcceptConditionsComponent, AcceptConditionsSuccessComponent, DocumentsComponent, FinishComponent, FaceComponent, IdentityResponseComponent, FingerprintMatchComponent, NewBankAccountComponent, DniComponent, InitialQueryComponent, InitAgentComponent, AuthDataComponent, AuthLoadDataComponent, OlimpiaComponent, QueryLoanSuccessComponent, FinishFlowComponent, AdditionalDataComponent, BankNoteComponent, PreApprovedComponent, ChooseAmountSuccessComponent, DniDetectorComponent, FaceDetectorComponent, FingerprintDetectorComponent, FeceDetectorPresentationComponent, DniDetectorPresentationComponent, DniValidationSuccessfullComponent, RejectpaymentComponent, RejectmegabaseComponent],
  imports: [
    CommonModule,
    FunnelRoutingModule,
    SharedModule,
