...
@NgModule({
  declarations: [TopbarComponent, OverlayCheckComponent, IntersitialComponent, VideoPlayerComponent, FingerprintVideoPlayerComponent, NewAccountFormComponent, DniPlayerComponent],
  exports: [
    TopbarComponent,
